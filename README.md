...
We randomly sample 100 videos (Youtube source) from LVD-2M, users can download them and the annotation file from [Google Drive](https://drive.google.com/drive/folders/1i6pk0RGJmO2AK15MeyXI7zE6_yOBQGhB?usp=drive_link)

We note that even a direct non-cherry picking random sample already presents very good quality.
